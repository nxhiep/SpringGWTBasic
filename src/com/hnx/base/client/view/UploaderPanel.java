package com.hnx.base.client.view;
...
public class UploaderPanel extends FlowPanel {
	...
	public void setButtonDisabled(boolean buttonDisabled) {
		uploader.setButtonDisabled(buttonDisabled);
	}
	
	public void setButtonHidden(boolean buttonHidden) {
		uploader.setVisible(buttonHidden);
	}
}